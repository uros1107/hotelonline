    ...
    <div id="content" class="pt10 pb30">
        <div class="container">
            <div class="row">
                ...
                if($num_records > 0){ ?>
                    <div class="isotopeWrapper clearfix isotope popup-gallery lazy-wrapper" data-loader="<?php echo getFromTemplate("common/get_images.php"); ?>" data-mode="click" data-limit="<?php echo $lz_limit; ?>" data-pages="<?php echo $lz_pages; ?>" data-more_caption="<?php echo $texts['LOAD_MORE']; ?>" data-is_isotope="true" data-variables="article_id=<?php echo $article_id; ?>">
