...
if(isset($db) && $db !== false){
    ...
    $my_page_alias = $sys_pages['activities']['alias'];
    ...
    $result_rate = $db->prepare('SELECT MIN(price) as price FROM pm_activity_session WHERE id_activity = :id_activity');
    ...
    foreach($result_activity as $i => $row){
        ...
        $activity_alias = DOCBASE.$my_page_alias.'/'.text_format($activity_alias);
