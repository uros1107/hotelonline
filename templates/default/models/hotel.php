                        ...
                        <div class="col-sm-8">
                            ...
                            if($result_rating !== false && $db->last_row_count() == 1){
                                ...
                                if($hotel_rating > 0 && $hotel_rating <= 5){ ?>
                                    ...
                                    <input type="hidden" class="rating pull-left" value="<?php echo $hotel_rating; ?>" data-rtl="<?php echo (RTL_DIR) ? true : false; ?>" data-size="xs" readonly="true" data-default-caption="<?php echo $count_rating.' '.$texts['RATINGS']; ?>" data-show-caption="false" data-show-clear="false">
                                    <?php
                                }
                            } ?>
