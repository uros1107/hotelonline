        ...
        <div class="dropup">
            ...
            <ul class="dropdown-menu" role="menu" aria-labelledby="lang-btn" id="lang-menu">
                ...
                foreach($currencies as $row){ ?>
                    <li><a href="<?php echo getUrl(); ?>" data-action="<?php echo getFromTemplate("common/change_currency.php"); ?>?curr=<?php echo $row['id']; ?>" class="ajax-link"><?php echo $row['code']." ".$row['sign']; ?></a></li>
                    <?php
                } ?>
            </ul>
        </div>
