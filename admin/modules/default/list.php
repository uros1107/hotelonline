                                        ...
                                        <table class="table table-hover table-striped" id="listing_base">
                                            <thead>
                                                <tr class="nodrop nodrag">
                                                    ...
                                                    <th width="140"><?php echo $texts['ACTIONS']; ?></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                if($result !== false){
                                                    ...
                                                    foreach($result as $i => $row){
                                                        ...
                                                        <tr id="item_<?php echo $id ?>">
                                                            ...
                                                            <?php
                                                            if(NB_FILES > 0){
                                                                if($result_img->execute() !== false && $db->last_row_count() > 0){
                                                            ...
                                                            <td class="text-center">
                                                                <?php
																if(NB_FILES > 0){
																	if($result_pdf->execute() !== false && $db->last_row_count() > 0){
                                                                ...
                                                                if(VALIDATION && (in_array('publish', $permissions) || in_array('all', $permissions))){
                                                                    if($checked == 0){ ?>
                                                                        <a class="tips" href="index.php?view=list&id=<?php echo $id; ?>&csrf_token=<?php echo $csrf_token; ?>&action=check" title="<?php echo $texts['PUBLISH']; ?>"><i class="fas fa-fw fa-check text-success"></i></a>
                                                                        <a class="tips" href="index.php?view=list&id=<?php echo $id; ?>&csrf_token=<?php echo $csrf_token; ?>&action=uncheck" title="<?php echo $texts['UNPUBLISH']; ?>"><i class="fas fa-fw fa-ban text-danger"></i></a>
