...
if($result !== false && $db->last_row_count() > 0){
    ...
    if($result_activity_file !== false && $db->last_row_count() > 0){
        ...
        if(is_file(SYSBASE."medias/activity/medium/".$file_id."/".$filename))
            $page_img = getUrl(true).DOCBASE."medias/activity/medium/".$file_id."/".$filename;
    }
                ...
                <div class="col-md-8 mb20">
                    <div class="row mb10">
                        <div class="col-sm-8">
                            ...
                            <p class="text-muted">
                                <i class="fas fa-fw fa-clock"></i> <?php echo $texts['DURATION']; ?> <?php echo $activity['duration']." ".$texts[mb_strtoupper($activity['duration_unit'])]; ?>
                            </p>
                        </div>
                        <div class="col-sm-4 text-right">
                            ...
                            <form action="<?php echo DOCBASE.$sys_pages['booking-activities']['alias']; ?>" method="post">
								<input type="hidden" name="activity_id" value="<?php echo $activity_id; ?>">
								<button type="submit" class="btn btn-success" name="book-activity"><?php echo $texts['BOOK']; ?></button>
                            </form>
                        </div>
                    </div>
                    <div class="row mb10">
                                ...
                                <a href="<?php echo DOCBASE.$page['alias']."/".text_format($activity_alias); ?>">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-8">
                                            ...
                                            <p class="text-muted">
                                                <i class="fas fa-fw fa-clock"></i> <?php echo $duration_value." ".$texts[mb_strtoupper($duration_unit)]; ?>
                                            </p>
                                            <?php
